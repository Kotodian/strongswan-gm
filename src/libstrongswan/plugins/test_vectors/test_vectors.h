...
TEST_VECTOR_CRYPTER(aes_cfb1)
TEST_VECTOR_CRYPTER(aes_cfb1s)
TEST_VECTOR_CRYPTER(aes_cfb2)
TEST_VECTOR_CRYPTER(aes_cfb2s)
TEST_VECTOR_CRYPTER(aes_cfb3)
TEST_VECTOR_CRYPTER(aes_cfb3s)
...
TEST_VECTOR_HASHER(sm3_1)
TEST_VECTOR_HASHER(sm3_2)
